<template>
    <div class="login_container">
        ...
        <el-dialog title="注册新用户" :visible.sync="registerVisible" width="50%" center>
            <el-form :model="registerForm" ref="registerRef" :rules="registerRule" label-width="80px">
                <el-form-item prop="username" label="用户名">
                    <el-input v-model="registerForm.username" :disabled="!checkCodeDisabled"></el-input>
                </el-form-item>
                <el-form-item prop="email" label="邮箱">
        ...
        return {
            ...
            loginFromRules: {
                ...
                password: [
                    ...
                    { min: 5, max: 16, message: "密码长度在8~16之间", trigger: "blur" }
                ]
            },
            registerRule: {
                username: [
                ...
                passwordNew2: [
                    ...
                    { validator: this.validatePassword, trigger: 'blur' },
                    { validator: this.validateConfirmPassword1, trigger: 'blur' }
                ]
            },
