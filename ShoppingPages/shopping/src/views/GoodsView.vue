  ...
  <div>
    ...
    <el-card>
            ...
            <template slot-scope="scope">
              ...
              <el-tooltip class="item" effect="dark" content="修改该商品" placement="bottom" v-if="power == 1">
                <el-button type="primary" icon="el-icon-edit" size="mini"
                           @click="eiditGoods(scope.row.goodsId)"></el-button>
              </el-tooltip>
              <el-button type="primary" icon="el-icon-circle-plus" v-if="power == 0" size="mini"
                         @click="addToShoppingCart(scope.row)">添加到购物车
              </el-button>
            </template>
          </el-table-column>
        </el-table>
          ...
          <el-col :span="6" v-for="item in goods" :key="item.goodsId">
            <el-card class="goods-card" shadow="hover">
              <div class="goods-image-container">
                ...
                <div class="goods-tag" v-if="item.inventory <= 10">
                  仅剩{{item.inventory}}件
                </div>
              </div>
              <div class="goods-content">
                <h3 class="goods-title" :title="item.goodsName">{{ item.goodsName }}</h3>
                <div class="goods-meta">
                  <span class="goods-type">{{ typeMap[item.type] }}</span>
                  <span class="goods-producer">{{ item.producer }}</span>
                  <span class="goods-date">{{ item.produceDate | formatDate }}</span>
                </div>
                <div class="goods-bottom">
                  ...
                  <div class="goods-action">
                    <el-input-number 
                      v-model="pickNumber[item.goodsId]"
                      :min="0"
                      :max="item.inventory"
                      size="mini"
                    ...
                    <el-button 
                      ...
                      :disabled="!pickNumber[item.goodsId]"
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                     :current-page="searchInform.page" :page-sizes="[10, 15, 20, 25]" :page-size="searchInform.pageSize"
                     layout="total, sizes, prev, pager, next, jumper" :total="this.total" style="text-align: center; margin-top: 20px;">
      </el-pagination>
    ...
    <el-dialog 
      ...
      <el-form 
        :model="addGoodsInform" 
        label-width="80px" 
        :rules="goodsInputRule" 
        ref="goodsInputRef"
        class="goods-form">
        <div class="form-content">
          <div class="form-left">
            <el-form-item label="商品名" prop="goodsName">
              <el-input v-model="addGoodsInform.goodsName" placeholder="请输入商品名称" size="small"></el-input>
            </el-form-item>
            <el-form-item label="厂家" prop="producer">
              <el-input v-model="addGoodsInform.producer" placeholder="请输入厂家名" size="small"></el-input>
            </el-form-item>
            <el-form-item label="生产日期" prop="produceDate">
              <el-date-picker 
                v-model="addGoodsInform.produceDate" 
                type="date" 
                placeholder="选择生产日期"
          ...
          <div class="form-right">
            <el-form-item label="进货价" prop="buyingPrice">
              <el-input v-model="addGoodsInform.buyingPrice" placeholder="请输入商品进货价格" size="small"></el-input>
            </el-form-item>
            <el-form-item label="售价" prop="price">
              <el-input v-model="addGoodsInform.price" placeholder="请输入商品的售价" size="small"></el-input>
            </el-form-item>
            <el-form-item label="库存" prop="inventory">
              <el-input-number 
                v-model="addGoodsInform.inventory" 
                :min="0" 
                size="small"
                style="width: 100%">
              </el-input-number>
            </el-form-item>
            <el-form-item label="商品照片" prop="picture">
              <el-input 
                v-model="addGoodsInform.picture" 
            ...
            <el-form-item label="照片预览">
              <el-image
                ...
                :src="addGoodsInform.picture"
                :preview-src-list="[addGoodsInform.picture]"
                fit="cover">
                <div slot="error" class="image-slot">
                  <i class="el-icon-picture-outline"></i>
                </div>
...
.goods-action .el-input-number {
  width: 100px;  /* 减小数字输入框宽度 */
}

.goods-action .el-button {
  flex: 1;
...
/* 修改 el-input-number 的样式 */
.goods-action .el-input-number.is-controls-right .el-input__inner {
  padding-left: 8px;
  padding-right: 30px;
}
